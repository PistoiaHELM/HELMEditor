...
public class NucleotideManager extends javax.swing.JDialog {
    ...
    private Nucleotide getNewNucleotide() {
        return new Nucleotide(symbolTextField.getText().trim(), NotationTextField.getText().trim());
    }
    ...
    private String validate(Nucleotide nuc) {
        ...
        try {
            normalMap = NucleotideFactory.getInstance().getNucleotideTemplates().get(NotationConstant.NOTATION_SOURCE);
        } catch (Exception ex) {
            Logger.getLogger(NucleotideManager.class.getName()).log(Level.SEVERE, null, ex);
        ...
        if (null == nuc.getSymbol() || nuc.getSymbol().length() == 0) {
            ...
            if (normalMap.containsKey(nuc.getSymbol())) {
                sb.append("Nucleotide symbol '" + nuc.getSymbol() + "' exists already;\n");
            }
        }
        ...
        if (null == nuc.getNotation() || nuc.getNotation().length() == 0) {
            ...
            if (normalMap.containsValue(nuc.getNotation())) {
                sb.append("Nucleotide notation '" + nuc.getNotation() + "' exists already;\n");
            } else {
                try {
                    SimpleNotationParser.validateSimpleNotation(nuc.getNotation(), Monomer.NUCLIEC_ACID_POLYMER_TYPE);
                } catch (Exception ex) {
                    sb.append("Nucleotide notation '" + nuc.getNotation() + "' is invalid;\n");
                }
            }
        }
    ...
    private void initComponents() {
        ...
        detailPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Define New Nucleotide"));
                ...
                .add(detailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, detailPanelLayout.createSequentialGroup()
                        .add(detailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(symbolLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(notationLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .add(16, 16, 16)
                        .add(detailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(NotationTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
                            .add(symbolTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)))
        ...
        detailPanelLayout.setVerticalGroup(
            ...
            .add(detailPanelLayout.createSequentialGroup()
                .add(detailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(symbolTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(symbolLabel))
                .add(18, 18, 18)
                .add(detailPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(NotationTextField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(notationLabel))
        ...
        summaryPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Nucleotide List"));
        ...
        summaryPanelLayout.setHorizontalGroup(
            ...
            .add(summaryPanelLayout.createSequentialGroup()
                .addContainerGap()
                .add(saveButton, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 133, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(136, Short.MAX_VALUE))
            .add(tableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 448, Short.MAX_VALUE)
        );
        summaryPanelLayout.setVerticalGroup(
            summaryPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(org.jdesktop.layout.GroupLayout.TRAILING, summaryPanelLayout.createSequentialGroup()
                .add(tableScrollPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 339, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
...
private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
    ...
    if (validationResult.length() > 0) {
        JOptionPane.showMessageDialog(getParent(), "Unable to register the nucleotide due to the following error(s):\n" + validationResult, "Register Warning", JOptionPane.WARNING_MESSAGE);
        return;
    }
...
private void nucleotideTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nucleotideTableMouseClicked
    if (evt.getClickCount() == 2) {
        ...
        if (rowIndex >= 0 && rowIndex < nucleotideTable.getRowCount()) {
            Nucleotide n = ((NucleotideTableModel) nucleotideTable.getModel()).getNucleotideList().get(row);
...
private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
    try {
        ...
        NucleotideFactory.getInstance().saveNucleotideTemplates();//GEN-LAST:event_saveButtonActionPerformed
            ...
            JOptionPane.showMessageDialog(getParent(), "Successfully saved nucleotide templates to local disk", "Save Success", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(getParent(), "Error saving nucleotide templates to local disk\n" + ex.getMessage(), "Save Failure", JOptionPane.ERROR_MESSAGE);
            Logger.getLogger(NucleotideManager.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
        }
