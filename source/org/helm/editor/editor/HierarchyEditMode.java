...
public class HierarchyEditMode extends EditMode {
	...
	/**
	 * Overwritten to display information about the template used to create the
	 * specified node.
	 */
	@Override
	...
	protected String getEdgeTip(final Edge edge) {
		...
		if (edge.getGraph() != null) {
			final EdgeMap edgeMap = (EdgeMap) edge.getGraph().getDataProvider(
					EdgeMapKeys.EDGE_INFO);
			if (edgeMap != null) {
